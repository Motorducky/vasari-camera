#!/usr/bin/env python3
"""
VASARI RIG V3 — Fixed 3D Effects

FIXES from V2:
- All 3D effects now use actual frame dimensions (rgb.shape) instead of global H,W
- Added borderMode=BORDER_REPLICATE to cv2.remap calls for out-of-bounds safety
- Fixed _lag_buffer to clear on mode change
- Improved slice bounds checking
